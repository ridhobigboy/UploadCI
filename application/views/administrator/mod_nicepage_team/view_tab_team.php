        ...
        <table id="nicepage-team-table" class="table table-sm table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <th style="width:200px">Foto Produk</th>
                    <th>Nama Produk</th>
            ...
            <?php if( !empty($get_team) ) {?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <ul>
                            <li>Link: <?php echo $team['socmed_fb'];?></li>
            ...
            <?php } else { ?>
                <tr>
                    <td class="no-data" colspan="4"> Belum ada Produk </td>
                </tr>
            <?php } ?>                
            </tbody>
        </table>
...
$(function(){ 
    $('.nicepage-btn-team-delete').on('click', function(e){
        e.preventDefault(); 
        var result = confirm('Apakah anda akan menghapus produk'+ $(this).data('nama') +' ?')
        if(result) {
