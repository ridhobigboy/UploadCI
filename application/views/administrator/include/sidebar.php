      ...
      <nav class="mt-2">
        ...
        <li class="nav-header">MAIN MENU</li>
          ...
          <li class="nav-item has-treeview module-nicepage">
            ...
            <p>Modul Web Page<i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview">
            <?php    
            //modnicepage team 
              $cek=$this->model_app->umenu_akses("nicepage-team",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item nicepage-team'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/nicepage-team'><i class='far fa-circle nav-icon text-success'></i> <p>Produk</p></a></li>";
            //modnicepage client 
              $cek=$this->model_app->umenu_akses("nicepage-client",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item nicepage-client'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/nicepage-client'><i class='far fa-circle nav-icon text-success'></i> <p>Pelanggan & Mitra</p></a></li>";
              }     
              }  
              //mod nicepage pengumuman
              $cek=$this->model_app->umenu_akses("nicepage-pengumuman",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item nicepage-pengumuman'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/nicepage-pengumuman'><i class='far fa-circle nav-icon text-success'></i> <p>Pengumuman</p></a></li>";
              } 
              //mod nicepage testimoni
              $cek=$this->model_app->umenu_akses("nicepage-testimoni",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item nicepage-testimoni'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/nicepage-testimoni'><i class='far fa-circle nav-icon text-success'></i> <p>Testimoni</p></a></li>";
              } 

              //mod nicepage
              $cek=$this->model_app->umenu_akses("nicepage",$this->session->id_session);
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item nicepage'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/nicepage'><i class='far fa-circle nav-icon text-success'></i> <p>Panel</p></a></li>";
              }  
