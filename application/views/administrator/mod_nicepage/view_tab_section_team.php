            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <select name="section_team[person_<?php echo $p;?>]" class="form-control">
                        <option value="" <?php echo (empty($get_section_team['person_'.$p])) ? 'selected="selected"' : '';?>>-- Pilih Produk --</option>
...
<div class="callout callout-info">
    <h5>Info</h5>
    <ul>
        <li>Isikan Nama / Keterangan Produk.</li>  
        <li>Isikan Masing-Masing Produk.</li>
