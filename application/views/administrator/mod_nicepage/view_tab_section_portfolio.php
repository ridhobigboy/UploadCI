...
<div class="callout callout-info">
    <h5>Info</h5>
    <ul>
        <li>Isikan Nama / Deskripsi Produk.</li>  
        <li>Batasi Produk yang ditampilkan dengan mengisi "Jumlah Yang Tampil".</li>
        <li>Pilih "Layout" yang sesuai.</li> 
        <li>"Label Link" untuk memberi nama link tautan ke halaman Produk (default:"selengkapnya").</li>
    </ul>
</div>