        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <input placeholder="Nama Produk" id="nama-project" type="text" class="form-control" name="nama_project" required="required">
                </div>
            </div> 
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">
                ...
                <div class="col-sm-6">
                    <input placeholder="No Produk" id="nama-client" type="text" class="form-control" name="nama_client">
                </div>
            </div> 
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input placeholder="https://produk" id="url" type="text" class="form-control" name="url" >
                </div>
            </div> 
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">
...
<div class="callout callout-info">
    ...
    <ul>
        ...
        <li>URL di biarkan kosong, isikan jika ada.</li>
    </ul>
</div>