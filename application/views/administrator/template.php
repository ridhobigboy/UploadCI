...
<head>
  ...
  <meta name="author" content="vanexweb.com">
  <!-- Font Awesome Icons -->
...
<div class="wrapper">
  ...
  <footer class="main-footer text-sm">
    <strong>Copyright &copy; 2022-<?php echo date('Y'); ?> <a target='_BLANK' href="http://www.mycoding.net/"><?php echo $iden['nama_website']; ?></a>.</strong>
    All rights reserved.
