...
echo "<div class='wrapper'>
	...
	echo "</ul>
	<p>&copy; ".date('Y')." Copyright <b>Blackexpo</b> News. All Rights reserved.<br/>Develop by. <b style='color:orange'>401XD Group</b> - Redesign by. <b style='color:orange'>Mycoding.net</b></p>
</div>";